...
using Quan_ly_doan_vien.Models;

namespace Quan_ly_doan_vien.Controllers
{
    public class XepLoaisController : Controller
    {
        private QLDV_Connect db = new QLDV_Connect();
        ...
        public ActionResult Details(int? id)
        {
            ...
            DoanVien tendoanvien = db.DoanViens.Find(xepLoai.DoanVien_Id);
            ViewBag.TenDoanVien = tendoanvien.Ten_dv;
            if (xepLoai == null)
            {
                return HttpNotFound();
            }
